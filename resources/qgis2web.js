...
map.getView().fit([8655355.441218, 650575.222209, 9332034.226642, 1112867.978066], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GGIS Web Mapping</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (82 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This Web Map visulaizes the transportation network and Waterways within Sri Lanka.';
            }
